...
/* debug only start */
/* add step counts to record i2c calling steps */
static int tfa9887_step = -1;
/*
 * Values of tfa9887_step_en:
 * 0: step disabled
 * 1: amp on/off
 * 2: ioctl
 */
...
void set_tfa9887_spkamp(int en, int dsp_mode)
{
	...
	/* enable to record i2c calling steps */
	tfa9887_step = 0;
	tfa9887_step_en = 1;
	...
	/* disable to record i2c calling steps */
	tfa9887_step_en = 0;
	tfa9887_step = -1;
	   ...
	   unsigned long arg)
{
	...
	case TPA9887_WRITE_CONFIG:
		...
		/* debug; KLOCK should be held before doing this */
		if (tfa9887_step_en)
